...
const { recordMtimes } = require('../install/file')
const { findFunctionsInTpl } = require('../tpl/definition')
...
async function getOrConvertFcfile (codeUri) {
...
module.exports = {
  buildFunction, copyNasArtifact, getOrConvertFunfile, getOrConvertFcfile
}
