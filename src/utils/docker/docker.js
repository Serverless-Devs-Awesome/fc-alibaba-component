...
const { generatePwdFile } = require('./passwd')
...
module.exports = {
  ...
  generateDockerEnvs,
  pullImageIfNeed,
  showDebugIdeTipsForVscode,
  resolveNasConfigToMounts,
  startInstallationContainer,
  startContainer,
  isDockerToolBoxAndEnsureDockerVersion,
  conventInstallTargetsToMounts,
  startSboxContainer,
  buildImage,
  copyFromImage,
  resolveTmpDirToMount,
  showDebugIdeTipsForPycharm,
  resolveDebuggerPathToMount,
  listContainers,
  getContainer,
