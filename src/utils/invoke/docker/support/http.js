...
async function validateSignature (req, res, method, credentials) {
  const signature = FC.getSignature(credentials.AccessKeyID, credentials.AccessKeySecret, method, req.path, req.headers, req.queries)
...
module.exports = {
  ...
  validateSignature,
  parseOutputStream,
  parseHttpTriggerHeaders,
  validateHeader,
  filterFunctionResponseAndExecutionInfo,
